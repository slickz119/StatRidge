...
beta_true <- c(0.5, 1, -1, 0.5, -0.7, 0.8)
...
# Summary
result1=colMeans(results)
result2=apply(results, 2, sd)
result3=colMeans(results) / colMeans(results)["ARPRR"]
result4=mean(results$ARPRR < results$PRR)
boxplot(results,main = "MSE Comparison of Estimators",ylab = "MSE")
